...
- Fixtures cover:
  ...
  - Mapping zone create, duplicate, split, delete, chromatic remap, and velocity fade edits, including explicit sample-asset selection for new zones
  ...
  - REX slice decoding, chromatic slice-program import from `.rex/.rx2`, and imported-program path compatibility across generic and legacy state properties
