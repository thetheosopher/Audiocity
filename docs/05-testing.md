...
- Fixtures cover:
  ...
  - SFZ import (#include/default_path/seq_length/release-trigger/seq_mode=random/velocity-crossfade playback/loop_continuous playback/one-shot playback/gain-pan-tuning playback)
  ...
  - legacy NKI probe classification plus nearby-sample resolution, group/zone metadata enumeration, simple playable translation including sample-window, loop, gain, pan, and tuning metadata, and explicit `.nki` imported-program state tagging
